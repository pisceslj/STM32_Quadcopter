...
/********************定义任务栈****************************/
__align(8) OS_STK task_bluetooth_stk[TASK_STK_SIZE];   //__align(8):八字节对齐
...
//__align(8) OS_STK task_led2_stk[TASK_LED2_STK_SIZE];
//__align(8) OS_STK task_led3_stk[TASK_LED3_STK_SIZE]; 
