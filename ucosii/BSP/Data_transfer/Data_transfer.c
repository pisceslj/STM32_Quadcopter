...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		Send_Status(Roll,Pitch,Yaw,baroAlt,0,fly_ready);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_senser)
	{
		f.send_senser = 0;
		Send_Senser(mpu6050.Acc.x,mpu6050.Acc.y,mpu6050.Acc.z,
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_rcdata = 0;
		Send_RCData(Rc_Pwm_In[0],Rc_Pwm_In[1],Rc_Pwm_In[2],Rc_Pwm_In[3],Rc_Pwm_In[4],Rc_Pwm_In[5],Rc_Pwm_In[6],Rc_Pwm_In[7],0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////	
	else if(f.send_motopwm)
	{
		f.send_motopwm = 0;
		Send_MotoPWM(1,2,3,4,5,6,7,8);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid1 = 0;
		Send_PID(1,ctrl_1.PID[PIDROLL].kp,ctrl_1.PID[PIDROLL].ki,ctrl_1.PID[PIDROLL].kd,
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid2 = 0;
		Send_PID(2,ctrl_1.PID[PID4].kp,ctrl_1.PID[PID4].ki,ctrl_1.PID[PID4].kd,
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid3 = 0;
		Send_PID(3,ctrl_2.PID[PIDROLL].kp,ctrl_2.PID[PIDROLL].ki,ctrl_2.PID[PIDROLL].kd,
